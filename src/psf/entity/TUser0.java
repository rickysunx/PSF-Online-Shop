package psf.entity;
public class TUser0 extends psf.framework.BasicEntity implements psf.framework.IBasicEntity,java.io.Serializable {
	...
	protected String [] _fields = new String[]{"uid","signature","avatarid","nowzoneid","homezoneid","realname","birthday","regtime","regip","snsstatus","idcardtype","idcardno","industryid","sex","ap_email","ap_sex","ap_mobile","ap_qq","ap_msn","ap_industry","ap_wealth","ap_wealthtype","ap_msg","sealflag"};
