package psf.entity;
public class VUser extends psf.framework.BasicEntity implements psf.framework.IBasicEntity,java.io.Serializable {
	...
	protected String [] _fields = new String[]{"uid","username","homezoneid","homeprovince","homecity","nowzoneid","nowprovince","nowcity","sex","email","signature","coins","cash","exps","points","coupon","fans","follows","friends","groupfriends","blogcount","showcount","guidecount","shopexpcount","visitcount","medal","postcount","avatarpic"};
