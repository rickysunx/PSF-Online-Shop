package psf.entity;
public class EcsSuppliers extends psf.framework.BasicEntity implements psf.framework.IBasicEntity,java.io.Serializable {
	...
	protected java.lang.String suppliers_sn = null;
	protected String [] _fields = new String[]{"suppliers_name","suppliers_desc","is_check","suppliers_id","buyers_id","suppliers_type","suppliers_license","suppliers_boss","suppliers_address","suppliers_phone","suppliers_mobile","suppliers_sn"};

	public EcsSuppliers() {
	}
	public String getTableName() {
		return "ecs_suppliers";
	}
	...
	public java.lang.String getSuppliers_sn() {
		return suppliers_sn;
	}
	public void setSuppliers_sn(java.lang.String suppliers_sn) {
		 this.suppliers_sn=suppliers_sn;
	}
}
