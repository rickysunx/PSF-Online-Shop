...
<script type="text/javascript">
	...
	function onGroupTabChanged(id) {
		if(id=='all'){
			loadFriendShow(null,-1,null,1,-1);
		}else if(id=='none'){
			loadFriendShow(0,-1,null,1,-1);
		}else{
			loadFriendShow(id,-1,null,1,-1);
		}
	}
</script>
<div class="tab_menu">
	...
	<div class="searchbox01">
		...
		<a class="searchbtn" href="javascript:void(0)" onclick="javascript:loadFriendShow(-1,-1,$('#search_show').val(),1,-1);"></a>
	</div>
