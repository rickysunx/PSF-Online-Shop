...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			loadShowList(1,-1,null,-1,-1);
		});
		
		function loadShowList(type,orderby,keyword,page,showTab){
			if(type != -1){
				options["type"] = type;
				var index = type*2-2;
...
<div id="sns_main" class="snsrbox s_clear">
	...
	<div id="sns_left">
		...
		<psf:include page="/sns/show/my_show_tab.jsp"/>
...
<!-- <psf:include page="/sns/components_float/forward_post.jsp"/> -->
</body>
</html>
