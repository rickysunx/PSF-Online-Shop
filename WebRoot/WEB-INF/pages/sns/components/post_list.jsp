...
<div id="autoPostDiv">
	<div id="autoPostCount"
		onclick='getLastUpdatePostList("autoPost", "/action/sns/get_last_update_post_list")'></div>
...
<c:if test="${!empty postListItems}">
	<psf:page pageCount="${pageCount}" page="${curPage}" href="#index_tab" action="javascript:loadPostList(-1,-1,-1,#page#);"></psf:page>
</c:if>
