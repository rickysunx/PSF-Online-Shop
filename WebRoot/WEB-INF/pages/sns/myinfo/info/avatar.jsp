...
function saveAvatar() {
	...
	$.post("/action/sns/save_avatar",
		{"d":imgDirection,"filename":currentAvatarFileName,"x":x,"y":y,"w":w,"h":h},
		function(data){
			if(data.success==1) {
			...
			<div class="avatar_right">
				...
				<div class="avatar_bigpreview">
					<div id="viewDiv" style="width:180px; height:180px;">
						<c:choose>
							<c:when test="${empty user.avatarid}"><img style="width: 100%;height: 100%;" src="/pic/1.jpg"/></c:when>
							<c:otherwise><img src="/pic/${user.avatarid}.jpg"/></c:otherwise>
						</c:choose>
					</div>
				</div>
			</div>
