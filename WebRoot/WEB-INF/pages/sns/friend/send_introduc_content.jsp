...
<script type="text/javascript">
	...
	function delSendIntro(uid,username){
		if(confirm("确定要删除您为"+username+"推荐好友记录？")){
			$.post(
				"/action/sns/friend/del_send_introduce","uid="+uid,
				function(data){
					if(data.success == 1){
...
<div class="introduc_item" id="introduce_${intro.touid }">
	<div class="introduc_item_header s_clear">
		...
		<div class="introduc_item_other">
			<div class="layerClose"><a class="close" href="javascript:delSendIntro(${intro.touid },'${intro.username }');"></a></div>
			<p>${intro.time }</p>
		</div>
	</div>
...
initPsfTypes();
	...
	<c:if test="${pageCount > 1}">
		<psf:page pageCount="${pageCount}" page="${curPage}" action="" href="/sns/friend/introducsend?page=#page#"></psf:page>
	</c:if>
