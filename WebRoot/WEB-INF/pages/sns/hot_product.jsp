...
<script type="text/javascript">
	$(function(){
		if(${!empty showTab}){
			loadRecommend('hot_product_list',6,1,1);
		}else if(${!empty expTab}){
			loadRecommend('hot_product_list',6,1,3);
		}else if(${!empty guideTab}){
			loadRecommend('hot_product_list',6,1,5);
		}
	});
</script>
<div class="hor3-list">
	<div class="sns-statustitle"><h3>热门${(!empty showTab)?'秀场':((!empty expTab)?'体验':((!empty guideTab)?'指南':''))}商品</h3></div>
	<div id="hot_product_list"></div>     
